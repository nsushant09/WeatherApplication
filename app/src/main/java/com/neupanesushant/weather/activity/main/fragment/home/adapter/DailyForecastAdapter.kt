...
class DailyForecastAdapter(val context : Context, val viewModel : HomeViewModel, private val list : List<Daily>) : RecyclerView.Adapter<DailyForecastAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.icon.setImageResource(viewModel.getWeatherIcon(dailyObject.weather[0].icon))
